...
public class ExcelUtil {
    ...
    public static void writeUserToExcel(List<User> users, String fileName, Context c) {
            ...
            try {
                ...
                for (int j = 0; j < users.size(); j++) {
                    ...
                    for (int col = 0; col < arrs.length; col++) {
                        sheet.addCell(new Label(col, j+1, arrs[col], arial10format));
                    }
//					for (int i = 0; i < 4; i++) {
//						sheet.addCell(new Label(i, j + 1, list.get(i),
//								arial12format));
